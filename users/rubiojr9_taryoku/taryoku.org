...
Please see the [[https://github.com/manna-harbour/qmk_firmware/blob/miryoku/users/rubiojr9_taryoku/miryoku.org][development branch]] for any [[https://github.com/qmk/qmk_firmware/compare/master...manna-harbour:miryoku][updates not yet merged into QMK]].
...
- [[#layout][Layout]]
  ...
  - [[#layers][Layers]]
    ...
    - [[#numerals-and-symbols-nsr][Numerals and Symbols (~NSR~)]]
    - [[#brackets-and-punctuation-bpl][Brackets and Punctuation (~BPL~)]]
    - [[#math-symbols-and-etc-msel][Math Symbols and Etc (~MSEL~)]]
...
- [[#subset-mapping][Subset Mapping]]
  - [[#userspace][Userspace]]
    - [[#usersrubiojr9_taryokurulesmk][users/rubiojr9_taryoku/rules.mk]]
    - [[#usersrubiojr9_taryokuconfigh][users/rubiojr9_taryoku/config.h]]
...
| A    | R    | S   | T   | G   | M   | N    | E   | I    | O    |
| Z    | X    | C   | D   | V   | K   | H    | ,   | DOT  | /    |
| U_NP | U_NP | TAB | SPC | ESC | ENT | BSPC | DEL | U_NP | U_NP |
...
|       | ALGR |      |      |     |      |      |      | ALGR |       |
| U_NP  | U_NP | MEDR | NAVR | NSR | MSEL | BPL  | FUNL | U_NP | U_NP  |
...
#+NAME: medr
| RGB_SPI | RGB_MOD  | RGB_HUI | RGB_SAI | RGB_VAI |
| RGB_TOG | MPRV     | VOLD    | VOLU    | MNXT    |
| RGB_SPD | RGB_RMOD | RGB_HUD | RGB_SAD | RGB_VAD |
| MSTP    | MPLY     | MUTE    | U_NP    | U_NP    |


*** Numerals and Symbols (~NSR~)

Primary right-hand layer (left outer thumb) is numerals and symbols.
Numerals have Colemak-DHm-like prioritization based on [[https://en.wikipedia.org/wiki/Benford%27s_law][Benford's Law]].
...
*** Brackets and Punctuation (~BPL~)
Key positions are picked based on finger position with Colemak-DHm-like prioritization
and position of related keys. The closing brackets are lower priority because
many editing environments will place a close bracket when an open bracket is entered.
...
*** Math Symbols and Etc (~MSEL~)
Key positions are picked based on finger position with Colemak-DHm-like prioritization
and position of related keys. The home row and the 4 under that are operators.
The equals is placed so it is easy to enter (OP)=.
Math operators and angle brackets are duplicated.
...
results = '  [' + layer_name + '] = LAYOUT_taryoku(\n'
...
#+BEGIN_SRC python :var hold_table=hold :var layer_name="NSR" :var half_table=nsr :var symbol_names_table=symbol-names :var mods_table=mods :var nonkc_table=nonkc :var shift="false" :tangle no :results verbatim
width = 9
mods_dict = dict.fromkeys(mods_table[0])
nonkc_tuple = tuple(nonkc_table[0])
symbol_names_dict = {}
...
The keymap is defined for ~LAYOUT_taryoku~ which is 10x4, with the outer 2
positions on the bottom row unused and the rest of the bottom row being the
thumb keys.


*** [[./rules.mk][users/rubiojr9_taryoku/rules.mk]]
...
*** [[./config.h][users/rubiojr9_taryoku/config.h]]
...
*** [[./rubiojr9_taryoku.h][users/manna-harbour_miryoku/manna-harbour_miryoku.h]]

Keymap-related definitions.  Included from ~rubiojr9_taryoku.c~.  Can be
included from keymap or layout ~keymap.c~ if needed.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle rubiojr9_taryoku.h
// <<header>>
...
*** [[./rubiojr9_taryoku.c][users/manna-harbour_miryoku/manna-harbour_miryoku.c]]

Contains the keymap.  Added from ~rules.mk~.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle rubiojr9_taryoku.c
// <<header>>
...
<<table-layout-half(layer_name="NSR", half_table=nsr)>>,
<<table-layout-half(layer_name="MSEL", half_table=msel)>>,
<<table-layout-half(layer_name="BPL", half_table=bpl)>>
};
#+END_SRC
...
To use the keymap on a keyboard supporting the layouts feature, ~LAYOUT_taryoku~
...
**** [[../../layouts/community/60_ansi/rubiojr9_taryoku/config.h][layouts/community/60_ansi/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/60_ansi/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/60_ansi/rubiojr9_taryoku/keymap.c][layouts/community/60_ansi/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/60_ansi/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make ergodox_ez:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../layouts/community/ergodox/rubiojr9_taryoku/config.h][layouts/community/ergodox/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ergodox/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/ergodox/rubiojr9_taryoku/keymap.c][layouts/community/ergodox/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ergodox/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make planck/rev6:rubiojr9_taryoku:flash # planck
make keebio/levinson:rubiojr9_taryoku:flash MIRYOKU_MAPPING=SPLIT # levinson
#+END_SRC


**** [[../../layouts/community/ortho_4x12/rubiojr9_taryoku/config.h][layouts/community/ortho_4x12/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ortho_4x12/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/ortho_4x12/rubiojr9_taryoku/keymap.c][layouts/community/ortho_4x12/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ortho_4x12/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make idobo:rubiojr9_taryoku:flash
make idobo:rubiojr9_taryoku:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # extended thumb position
#+END_SRC


**** [[../../layouts/community/ortho_5x15/rubiojr9_taryoku/config.h][layouts/community/ortho_5x15/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ortho_5x15/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/ortho_5x15/rubiojr9_taryoku/keymap.c][layouts/community/ortho_5x15/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/ortho_5x15/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make planck/ez:rubiojr9_taryoku:flash
#+END_SRC

**** [[../../layouts/community/planck_mit/rubiojr9_taryoku/config.h][layouts/community/planck_mit/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/planck_mit/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/planck_mit/rubiojr9_taryoku/keymap.c][layouts/community/planck_mit/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/planck_mit/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make minidox:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../layouts/community/split_3x5_3/rubiojr9_taryoku/config.h][layouts/community/split_3x5_3/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/split_3x5_3/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/split_3x5_3/rubiojr9_taryoku/keymap.c][layouts/community/split_3x5_3/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/split_3x5_3/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make crkbd:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../layouts/community/split_3x6_3/rubiojr9_taryoku/config.h][layouts/community/split_3x6_3/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/split_3x6_3/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../layouts/community/split_3x6_3/rubiojr9_taryoku/keymap.c][layouts/community/split_3x6_3/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../layouts/community/split_3x6_3/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
~LAYOUT_taryoku~ is defined as a macro mapping onto the keyboard's own ~LAYOUT~
...
#+BEGIN_SRC sh :tangle no
make atreus:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/atreus/keymaps/rubiojr9_taryoku/config.h][keyboards/atreus/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/atreus/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/atreus/keymaps/rubiojr9_taryoku/keymap.c][keyboards/atreus/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/atreus/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make for_science:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/for_science/keymaps/rubiojr9_taryoku/config.h][keyboards/for_science/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/for_science/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/for_science/keymaps/rubiojr9_taryoku/keymap.c][keyboards/for_science/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/for_science/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make gergo:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/gergo/keymaps/rubiojr9_taryoku/config.h][keyboards/gergo/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/gergo/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/gergo/keymaps/rubiojr9_taryoku/keymap.c][keyboards/gergo/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/gergo/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make keebio/iris/rev4:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/iris/keymaps/rubiojr9_taryoku/config.h][keyboards/keebio/iris/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/keebio/iris/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/iris/keymaps/rubiojr9_taryoku/keymap.c][keyboards/keebio/iris/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/keebio/iris/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make kyria:rubiojr9_taryoku:flash
make kyria:rubiojr9_taryoku:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # extended thumb position
#+END_SRC


**** [[../../keyboards/kyria/keymaps/rubiojr9_taryoku/config.h][keyboards/kyria/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/kyria/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/kyria/keymaps/rubiojr9_taryoku/keymap.c][keyboards/kyria/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/kyria/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make lily58:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/lily58/keymaps/rubiojr9_taryoku/config.h][keyboards/lily58/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/lily58/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/lily58/keymaps/rubiojr9_taryoku/keymap.c][keyboards/lily58/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/lily58/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make moonlander:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/moonlander/keymaps/rubiojr9_taryoku/config.h][keyboards/moonlander/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/moonlander/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/moonlander/keymaps/rubiojr9_taryoku/keymap.c][keyboards/moonlander/keymaps/manna-harbour_miryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/moonlander/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make redox_w:rubiojr9_taryoku:flash
#+END_SRC


**** [[../../keyboards/redox_w/keymaps/rubiojr9_taryoku/config.h][keyboards/redox_w/keymaps/manna-harbour_miryoku/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/redox_w/keymaps/rubiojr9_taryoku/config.h
// <<header>>
...
**** [[../../keyboards/redox_w/keymaps/rubiojr9_taryoku/keymap.c][keyboards/redox_w/keymaps/rubiojr9_taryoku/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :noweb yes :padline no :main no :tangle ../../keyboards/redox_w/keymaps/rubiojr9_taryoku/keymap.c
// <<header>>
#+END_SRC
...
To add customisations to a keyboard or layout while importing the taryoku
keymap, copy ~config.h~ and ~keymap.c~ from the keyboard or layout's
~rubiojr9_taryoku/~ directory to a new directory, and create ~rules.mk~
containing ~USER_NAME := rubiojr9_taryoku~.  The taryoku keymap will be
imported and customisations can be added to those files as usual.  Keycodes can
be added to unused keys by editing ~LAYOUT_taryoku~ in ~config.h~.

For an unsupported keyboard or layout, do as above with a similar keyboard or
layout and modify ~LAYOUT_taryoku~ in ~config.h~ referring to the keyboard or
